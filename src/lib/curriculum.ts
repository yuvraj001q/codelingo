...
export const curriculum: Record<string, LessonExercises[]> = {
  ...
  rust: [
    {
      ...
      exercises: [
        {
          id: "rs-intro-1",
          lesson_id: "rust-u0-l0",
          type: "concept",
          question: "What makes Rust unique?",
          code_snippet: undefined,
          options: [],
          correct_answer: "",
          explanation: "Rust guarantees memory safety without a garbage collector using its ownership system. It compiles to native code and rivals C++ in performance.",
          difficulty: 1,
        },
        {
          id: "rs-intro-2",
          ...
          code_snippet: undefined,
          options: ["Graydon Hoare", "Brendan Eich", "Linus Torvalds", "Bjarne Stroustrup"],
          correct_answer: "Graydon Hoare",
          explanation: "Rust began as a personal project by Graydon Hoare at Mozilla Research in 2006.",
          difficulty: 1,
        },
        {
          id: "rs-intro-3",
          ...
          correct_answer: "The package manager and build tool",
          explanation: "Cargo is Rust's build system and package manager. You create projects with `cargo new` and build with `cargo build`.",
          difficulty: 1,
        },
      ],
    },
    {
      ...
      exercises: [
        {
          id: "rs-hello-1",
          lesson_id: "rust-u0-l1",
          type: "multiple_choice",
          question: "What is the correct main function signature in Rust?",
          code_snippet: undefined,
          options: [
            "fn main() { }",
            "void main() { }",
          ...
          correct_answer: "fn main() { }",
          explanation: "Rust uses `fn` to declare functions. The entry point is `fn main()`.",
          difficulty: 1,
        },
        {
          id: "rs-hello-2",
          ...
          options: [],
          correct_answer: "Hello, World!",
          explanation: "println! is a macro that prints text followed by a newline. Strings use double quotes.",
          difficulty: 1,
        },
        {
          id: "rs-hello-3",
          lesson_id: "rust-u0-l1",
          type: "syntax_drag",
          question: "Arrange a complete Rust hello world:",
          code_snippet: undefined,
          options: [
            "fn main() {",
            '    println!("Hello, Rust!");',
          ...
          correct_answer: 'fn main() {\n    println!("Hello, Rust!");\n}',
          explanation: "Every Rust program needs a main function. println! with a string is the standard output macro.",
          difficulty: 1,
        },
      ],
    },
    {
      ...
      exercises: [
        {
          id: "rs-vars-1",
          lesson_id: "rust-u0-l2",
          type: "fill_blank",
          question: "Declare a mutable variable in Rust:",
          code_snippet: "______ mut x = 42;",
          options: [],
          correct_answer: "let",
          explanation: "Variables are declared with `let`. Adding `mut` makes them mutable.",
          difficulty: 1,
        },
        {
          id: "rs-vars-2",
          ...
          explanation: "Rust variables are immutable by default. The compiler catches reassignment attempts at compile time.",
          difficulty: 2,
        },
      ],
    },
      ...
      exercises: [
        {
          ...
          code_snippet: undefined,
          options: ["Bjarne Stroustrup", "Dennis Ritchie", "Brian Kernighan", "James Gosling"],
          correct_answer: "Bjarne Stroustrup",
          explanation: "Bjarne Stroustrup developed C++ as an extension of C, adding object-oriented features.",
          difficulty: 1,
        },
        {
          id: "cpp-intro-2",
          lesson_id: "cpp-u0-l0",
          type: "fill_blank",
          question: "Include the iostream header for input/output:",
          code_snippet: "#include ______",
          options: [],
        ...
        },
        {
          ...
          code_snippet: undefined,
          options: ["int main()", "void main()", "fn main()", "public static void main()"],
          correct_answer: "int main()",
          explanation: "C++ programs start execution at the main() function, which returns an integer.",
          difficulty: 1,
        },
      ],
    },
      ...
      exercises: [
        {
          ...
          code_snippet: "______ score = 100;",
          options: [],
          correct_answer: "int",
          explanation: "C++ requires explicit type declarations. `int` is for integer values.",
          difficulty: 1,
        },
        {
          id: "cpp-vars-2",
          lesson_id: "cpp-u0-l1",
          type: "multiple_choice",
          question: "How do you print to the console in C++?",
          code_snippet: undefined,
          options: [
            "std::cout << \"Hello\";",
            "print(\"Hello\");",
          ...
          correct_answer: 'std::cout << "Hello";',
          explanation: "std::cout is the standard output stream. Use << to send data to it.",
          difficulty: 1,
        },
      ],
    },
      ...
      exercises: [
        {
          ...
          lesson_id: "go-u0-l0",
          type: "concept",
          question: "What is Go designed for?",
          code_snippet: undefined,
          options: [],
          correct_answer: "",
          explanation: "Go was designed at Google for building efficient, scalable server-side applications. It emphasizes simplicity, fast compilation, and built-in concurrency.",
          difficulty: 1,
        },
        {
          id: "go-intro-2",
      ...
      exercises: [
        {
          ...
          lesson_id: "go-u0-l1",
          type: "fill_blank",
          question: "Declare the package as main in a Go program:",
          code_snippet: "______ main",
          options: [],
          correct_answer: "package",
          explanation: "Every Go file starts with `package name`. Executable programs use `package main`.",
          difficulty: 1,
        },
        {
          id: "go-pkg-2",
          ...
          explanation: "Go uses the `import` keyword followed by the package path in double quotes.",
          difficulty: 1,
        },
        {
          id: "go-pkg-3",
          lesson_id: "go-u0-l1",
          type: "fill_blank",
          question: "Complete hello world in Go:",
          code_snippet: 'package main\nimport "fmt"\n\nfunc main() {\n    fmt.______("Hello, World!")\n}',
          options: [],
          correct_answer: "Println",
          explanation: "fmt.Println prints a line to stdout. The capital P means it's an exported function.",
          difficulty: 1,
        },
      ],
    },
  ...
  typescript: [
    {
      lessonId: "typescript-u0-l0",
      exercises: [
        {
          id: "ts-intro-1",
          lesson_id: "typescript-u0-l0",
          type: "concept",
          question: "How does TypeScript relate to JavaScript?",
          code_snippet: undefined,
          options: [],
          correct_answer: "",
          explanation: "TypeScript is a superset of JavaScript that adds static typing. All JavaScript code is valid TypeScript, but TypeScript adds type annotations, interfaces, and more.",
          difficulty: 1,
        },
        {
          id: "ts-intro-2",
          ...
          explanation: "TypeScript was developed by Microsoft and first released in 2012. It was led by Anders Hejlsberg.",
          difficulty: 1,
        },
      ],
    },
    {
      lessonId: "typescript-u0-l1",
      exercises: [
        {
          id: "ts-types-1",
          lesson_id: "typescript-u0-l1",
          type: "fill_blank",
          question: "Add a type annotation to this parameter:",
          code_snippet: "function greet(name: ______) {",
          options: [],
          correct_answer: "string",
          explanation: "TypeScript uses colon syntax for type annotations. `name: string` means name must be a string.",
          difficulty: 1,
        },
        {
          id: "ts-types-2",
          lesson_id: "typescript-u0-l1",
          type: "multiple_choice",
          question: "What type does TypeScript infer for `let x = 42;`?",
          code_snippet: undefined,
          options: ["number", "int", "Number", "any"],
          correct_answer: "number",
          explanation: "TypeScript infers the type as `number` since 42 is a numeric literal.",
          difficulty: 1,
        },
        {
          id: "ts-types-3",
          lesson_id: "typescript-u0-l1",
          type: "multiple_choice",
          question: "How do you declare a variable that can be string or null?",
          code_snippet: undefined,
          options: [
            "let x: string | null;",
            "let x: string?;",
          ...
          correct_answer: "let x: string | null;",
          explanation: "Union types use the `|` operator. `string | null` means the value can be either type.",
          difficulty: 2,
        },
      ],
    },
